...
function getAllData() {
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#date').val(posts['date']);
      $('#time').val(posts['time']);
      $('#carNumber').val(posts['carNumber']);
      $('#carType').val(posts['carType']);
      $('#departure').val(posts['departure']);
      $('#phoneNumber').val(posts['phoneNumber']);
      $('#amountPallet').val(posts['amountPallet']);
